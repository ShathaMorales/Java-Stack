...
<body>
	<div class="container-md-fluid m-5 p-5">
    	...
    	<h1 style="color:blue"class="text-center">Project Manager</h1>
                ...
                <form:form action="/register" method="post" modelAttribute="newUser">
                    <div class="form-floating my-3">
                      ...
                      <form:label path="firstName" for="floatingInput">First Name</form:label>
                        <form:errors path="firstName" class = "my-3" style="color: blue;"/>
                    </div>
                    <div class="form-floating my-3">
                      ...
                      <form:label path="lastName" for="floatingInput">Last Name</form:label>
                        <form:errors path="lastName" class = "my-3" style="color: blue;"/>
                    </div>
                    <div class="form-floating my-3">
                      ...
                      <form:label path="email" for="floatingInput">Email</form:label>
                        <form:errors path="email" class = "my-3" style="color: blue;"/>
                    </div>
                    <div class="form-floating my-3">
                      ...
                      <form:label path="password" for="floatingInput">Password</form:label>
                        <form:errors path="password" class = "my-3" style="color: blue;"/>
                    </div>
                    <div class="form-floating my-3">
                      ...
                      <form:label path="confirm" for="floatingInput">Confirm Password</form:label>
                        <form:errors path="confirm" class = "my-3" style="color: blue;"/>
                    </div>
                    <button type="submit" class="btn btn-outline-primary align-self-center">Register</button>
                    </form:form>
    		</div>
    		 <div class = "col-5 mt-5">
                ...
                <form:form action="/login" method="post" modelAttribute="newLogin">
                    ...
                    <button type="submit" class="btn btn-outline-primary align-self-center">Log In</button>
                    </form:form>
    		</div>
    		</div>
    </div>
