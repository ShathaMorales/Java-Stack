...
<body>
    <div class = "container-md-fluid m-5 p-5">
        <div class = "row justify-content-center">
            <div class = "col-7 ">
            <h5>Hello, <c:out value="${userName}"></c:out> welcome to..</h5>
            ...
            <div class = "col-9 ">
                        ...
                        <td><c:out value="${book.user.userName}"></c:out></td>
                            ...
                            <c:choose>
                                ...
                                <div class="d-flex gap-3">
                                    <td><a class="btn btn-outline-primary" href="/books/${book.id}/edit">edit</a> | 
                                ...
                                <c:otherwise>
                                    <td><a class="btn btn-outline-primary" href="/books/${book.id}/borrow">Borrow</a></td>
                                </c:otherwise>
                            </c:choose>
                    </tr>
                    	</c:if>
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><c:out value="${book.author}"></c:out></td>
                        <td><c:out value="${book.user.userName}"></c:out></td>
                        <td><a class="btn btn-outline-primary" href="/books/${book.id}/return">Return</a></td>
                    </tr>
                    	</c:if>
                    </c:forEach>
                  </tbody>
