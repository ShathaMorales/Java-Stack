...
public class TestOrder {
    ...
    public static void main(String[] args) {
        ...
        coffeeKiosk.addMenuItem("Choclate Chip Cookie", 4.00);
        coffeeKiosk.addMenuItem("Drip Coffee", 2.50);
        coffeeKiosk.addMenuItem("Mocha", 3.20);
        coffeeKiosk.addMenuItem("Brownie", 5.00);
        coffeeKiosk.addMenuItem("Cappuccino", 5.00);
        coffeeKiosk.newOrder();

        //Menu Items
        Item item1 = new Item("Drip Coffee", 2.50);
        Item item2 = new Item("latte", 4.50);
        Item item3 = new Item("Mocha", 3.20);
